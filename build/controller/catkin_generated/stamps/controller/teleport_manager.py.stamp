...
class TeleportManager:
    def __init__(self, model_name='B1', reference_frame='world'):
        """
        Initializes the TeleportManager by setting up the service proxy and defining teleport positions.
        
        :param model_name: Name of the robot model in Gazebo.
        :param reference_frame: Reference frame for the teleport (usually 'world').
        """
        self.model_name = model_name
        self.reference_frame = reference_frame
        self.teleport_positions = self.define_teleport_positions()
        self.set_model_state_service = self.initialize_service()

    def define_teleport_positions(self):
        """
        Defines the teleport positions with predefined coordinates and orientations.
        
        :return: Dictionary of teleport positions.
        """
        return {
            'TP1': {
    ...
    def initialize_service(self):
        """
        Initializes the service proxy for setting the model state in Gazebo.
        
        :return: Service proxy for /gazebo/set_model_state
        """
    ...
    def teleport_to_position(self, tp_name):
        ...
        model_state.model_name = self.model_name  # Ensure this matches your robot's model name in Gazebo
        ...
        model_state.reference_frame = self.reference_frame  # Relative to the 'world' frame
